	...
	<div id="studentvisio_header">
        ...
        <div id="studentvisio_menu">
            <ul><br /><br />
                ...
                <li><a href="regestartion.html" class="current">Services</a></li>
...
mysql_query("INSERT INTO login(fname, lname, username, password)VALUES('$fname', '$lname', '$username', '$password')");
//header("location: regestration.php?remarks=success");
mysql_close($bd);
echo " REGESTRATION SUCCESS ";
header("Location:http://localhost:8087/studentvisio/login.php");
?>
	</div> <!-- end of content -->
